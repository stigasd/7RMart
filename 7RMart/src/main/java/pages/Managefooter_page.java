...
public class Managefooter_page {
	...
	private WebElement addressInput_field;
	@FindBy(xpath = "//input[@id='email']")
	private WebElement emailInput_field;
	@FindBy(xpath = "//input[@id='phone']")
	private WebElement phoneInput_field;
...
//		waitutilities.waitForElementToBeClickable(driver, update_button);
		update_button.click();
		return this;
